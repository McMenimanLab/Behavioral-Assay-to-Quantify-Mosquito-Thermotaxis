...
os.chdir("/home/pi/Desktop/Protocol_data/Temperature") #change directory to folder where you want data
                                                        #to be stored


ser = serial.Serial('/dev/ttyACM0',9600,timeout=1) # start serial communication. Make sure the port is the correct
